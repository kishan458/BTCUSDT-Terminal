from pillar6_high_impact_events.nfp_outcome_collector import build_nfp_outcomes

def build_nfp_probabilities(startyear="2024", endyear="2026"):
    outcomes = build_nfp_outcomes(startyear, endyear)
